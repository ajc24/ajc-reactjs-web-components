...
const FileUploadPdf = props => {
  return <BaseFileInput accept="pdf" alignment={props.alignment || 'left'} backgroundColour={props.backgroundColour || 'white'} errorMessage={props.errorMessage}
    fileSizeLimit={props.fileSizeLimit} id={`${props.id}--file-upload-pdf`} isDisabled={props.isDisabled || false} isOptionalFormField={props.isOptionalFormField || false}
